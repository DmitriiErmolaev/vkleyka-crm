...
const AllApplications = () => {
  ...
  const [applicantsData, applicantsLoading, applicantsError, applicantsCollSnapshot] = useCollectionData(CLIENTS_QUERY);
  ...
  useEffect(() => {
    if(applicationsData && applicantsData && countriesData.countries && chatsCollSnapshot) {
  ...
  }, [applicationsData, applicantsData, countriesData, chatsCollSnapshot, appsCollSnapshot])
  ...
  if(tableError || countriesError || applicantsError || chatsError) {
    return <Error error={tableError || countriesError || applicantsError || chatsError}/>
  }
